...
import io.github.danbrough.libssh2.cinterop.libssh2_channel_free
...
class ChannelOld(private val session: SessionNative, private val channel: CPointer<LIBSSH2_CHANNEL>) :
  AutoCloseable {
