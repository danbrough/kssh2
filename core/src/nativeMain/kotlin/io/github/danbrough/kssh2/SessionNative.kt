...
import io.github.danbrough.libssh2.cinterop.LIBSSH2_HOSTKEY_TYPE_DSS
import io.github.danbrough.libssh2.cinterop.LIBSSH2_HOSTKEY_TYPE_ECDSA_256
import io.github.danbrough.libssh2.cinterop.LIBSSH2_HOSTKEY_TYPE_ECDSA_384
import io.github.danbrough.libssh2.cinterop.LIBSSH2_HOSTKEY_TYPE_ECDSA_521
import io.github.danbrough.libssh2.cinterop.LIBSSH2_HOSTKEY_TYPE_ED25519
import io.github.danbrough.libssh2.cinterop.LIBSSH2_HOSTKEY_TYPE_RSA
import io.github.danbrough.libssh2.cinterop.LIBSSH2_HOSTKEY_TYPE_UNKNOWN
import io.github.danbrough.libssh2.cinterop.LIBSSH2_KNOWNHOSTS
import io.github.danbrough.libssh2.cinterop.LIBSSH2_KNOWNHOST_CHECK_FAILURE
import io.github.danbrough.libssh2.cinterop.LIBSSH2_KNOWNHOST_CHECK_MATCH
import io.github.danbrough.libssh2.cinterop.LIBSSH2_KNOWNHOST_CHECK_MISMATCH
import io.github.danbrough.libssh2.cinterop.LIBSSH2_KNOWNHOST_CHECK_NOTFOUND
import io.github.danbrough.libssh2.cinterop.LIBSSH2_KNOWNHOST_FILE_OPENSSH
import io.github.danbrough.libssh2.cinterop.LIBSSH2_KNOWNHOST_KEYENC_BASE64
import io.github.danbrough.libssh2.cinterop.LIBSSH2_KNOWNHOST_TYPE_PLAIN
...
import io.github.danbrough.libssh2.cinterop.libssh2_knownhost
import io.github.danbrough.libssh2.cinterop.libssh2_knownhost_checkp
import io.github.danbrough.libssh2.cinterop.libssh2_knownhost_free
import io.github.danbrough.libssh2.cinterop.libssh2_knownhost_init
import io.github.danbrough.libssh2.cinterop.libssh2_knownhost_readfile
...
import io.github.danbrough.libssh2.cinterop.libssh2_session_hostkey
...
//        sin_port = io.github.danbrough.kssh2.cinterop.ssh2_htons(config.port.convert())
//        sin_addr.s_addr = io.github.danbrough.kssh2.cinterop.inetAddr(config.hostName)
//      }*/
//
...
or via libssh2_channel_direct_tcpip or libssh2_channel_forward_listen
      ...
      if (channel != null) return ChannelOld(this, channel)
      rc = libssh2_session_last_errno(session)
